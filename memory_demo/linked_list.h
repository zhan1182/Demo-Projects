...
{
	char* name; // name associated with this entry
	char* value; // value associated with this name
...
typedef struct LINKED_LIST 
{
 ...
 This entry is not used to stored data. It is only used to delimit the list. */
} LINKED_LIST;
